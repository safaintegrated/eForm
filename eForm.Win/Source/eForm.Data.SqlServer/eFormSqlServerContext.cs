...
{
    public class eFormSqlServerContext : DbContext
    {
        private string _dbPath;

        public eFormSqlServerContext()
            : base("eFormDbConnection")
        {
            ...
            Database.SetInitializer<eFormSqlServerContext>(new eFormContextInitializer());
        }
