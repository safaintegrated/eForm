...
namespace eForm.Win
{
    public class eFormContext : DbContext
    {
        ...
        public eFormContext()
            : base()
        {
            var path = Constant.DatabasePath;// Path.Combine(directory, @"ApplicationName\MyDatabase.sdf");
            ...
            Database.SetInitializer<eFormContext>(new eFormContextInitializer());
        }

        public eFormContext(string _dbPath)
        {
