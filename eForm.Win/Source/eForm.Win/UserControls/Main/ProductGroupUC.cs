...
{
    public partial class ProductGroupUC : UserControl
    {
        ...
        {
            if (_mf.Application == null)
                return;
            _mf.Application.EndUserTypeEnum = EndUserTypeEnum.Residential;
            _mf.Application.ProductTypeEnum = ProductTypeEnum.Unifi;
            _mf.Application.ApplicationTypeEnum = ApplicationTypeEnum.NewRegistration;
